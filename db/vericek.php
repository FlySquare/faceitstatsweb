...
$site2 = file_get_contents("https://faceitelo.net/");
...
preg_match_all('@<section class="section grey">(.*?)</section>@si', $site2, $name12);
preg_match_all('@<section class="section ">(.*?)</section>@si', $site2, $name13);
...
$namecikti12 = implode("bon", $name12[1]);
$namedizi12 = explode ("bon",$namecikti12);

$namecikti13 = implode("bon", $name13[1]);
$namedizi13 = explode ("bon",$namecikti13);
$link= $namedizi2[1];
$dizi = explode ("/",$link);
